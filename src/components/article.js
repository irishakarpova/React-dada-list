...
class Article extends Component {
    ...
    render() {
        ...
        const title = cssColor
            ? "articleTitle"
            : "articleTitleOn test_open_data";
            ...
            <div>
                <article className={classes("bg-article")}>
                    <div className={classes("container p-0")}>
                        <div
                            className={classes(
                                "row p-0 justify-content-md-center"
                            )}
                        >
    ...
    getBody() {
        ...
        return (
            <section className={classes("bg-section test_data")}>
                <div className={classes("article-location")}>
                    <p>{article.location}</p>
                </div>
                <div className={classes("article-text")}>
                    <p>{article.description}</p>
                </div>
                <div className={classes("article-member")}>
                    <p>{article.members}</p>
                </div>
            </section>
        );
...
export default connect(null, { loadArticleById })(Article);
